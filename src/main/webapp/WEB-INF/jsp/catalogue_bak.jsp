		  ...
		  <tr>
		   ...
		   <c:choose >
		      <c:when test="${cart.count gt 0}">
		         <td><a href="<c:url value='/spring/checkout-flow' />" class="btn btn-info btn-sm">
		           Checkout</a> </td>
              </c:when>
              <c:otherwise>
                 <td>&nbsp;</td>
		   ...
		   <td> <input type="submit" id="btnUpdate" value="Update Cart" class="btn btn-warning btn-sm" /></td>
		  </tr>
		  <tr>
		    <th>ID</th>
		    <th>Title</th>
