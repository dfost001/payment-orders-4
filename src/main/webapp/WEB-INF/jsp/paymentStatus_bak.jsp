...
<body>
  ...
  <div class="panel panel-info">
			...
			<div class="panel-heading">				
					...
					<a id="btnRefund" href="<c:url value='/spring/refund/request/${orderId}'/>" class="btn btn-warning" style="margin-left:8px"> 
						Refund Payment  </a>
    ...
    <fieldset>	
		...
		<table class="table">
		   ...
		   <tr>
		    ...
		    <td>Funding details will be sent to: <label>${details.billingEmail}</label></td>
		   </tr>
		    <tr>
		    <td><label>Funding Source:</label></td>
		    <td>****${details.lastDigits}</td>
		   </tr>
		   <tr>
